...
from illuminnet.AutoEncoder.vanilla.loader import AutoEncoderDataset
...
from illuminnet.AutoEncoder.vanilla.callback import AutoEncoderCallback
...
if __name__ == '__main__':
    ...
    #   Add callbacks
    #
    train_loop_handler.add_callback([AutoEncoderCallback(10, hdr_image_handler, train_dataset.from_index)])
